...
def mapillary():
    if mapillary_client_id is None:
        ...
        exit(-1)
    return {"name": "mapillary", "api" : "https://a.mapillary.com/v3", "tracks": "/sequences", 'params': {'bbox': '{minx},{miny},{maxx},{maxy}', 'start_time': '2019-08-21T00:00:00Z', 'end_time': '2019-08-22T00:00:00Z', 'usernames': 'kaart5', "client_id": str(mapillary_client_id)}}
